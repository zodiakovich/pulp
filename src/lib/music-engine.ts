...
export const GENRES: Record<string, GenreProfile> = {
  'deep_house': {
    ...
    chordProgressions: [[0,3,4,0], [0,5,3,4], [0,2,3,4], [0,3,5,4], [0,5,3,2], [3,4,0,5], [0,4,5,3], [0,2,5,4]],
  ...
  'melodic_house': {
    ...
    chordComplexity: 'sevenths', chordRhythm: 'sustained',
    chordProgressions: [[0,3,4,5], [0,5,6,4], [0,4,5,3], [5,4,0,3], [0,5,3,4], [3,5,4,0], [0,2,5,4], [0,5,2,4]],
    bassStyle: 'root', bassOctave: 2,
  ...
  'tech_house': {
    ...
    chordProgressions: [[0,0,3,4], [0,4,0,3], [0,3,0,4], [0,0,0,3], [0,3,4,3], [0,0,4,3], [3,0,4,0]],
  ...
  'minimal_tech': {
    ...
    chordComplexity: 'triads', chordRhythm: 'stabs',
    chordProgressions: [[0,0,0,3], [0,3,0,0], [0,0,4,0], [0,0,0,0], [0,3,0,4], [0,0,3,0]],
    bassStyle: 'syncopated', bassOctave: 2,
    drumPattern: 'four_on_floor', hatDensity: 16, swingAmount: 0, energy: 0.6,
  },
  'techno': {
    ...
    chordComplexity: 'triads', chordRhythm: 'stabs',
    chordProgressions: [[0,0,3,3], [0,4,0,3], [0,0,0,4], [0,1,0,4], [0,5,0,4], [0,0,4,1]],
  ...
  'melodic_techno': {
    ...
    chordComplexity: 'sevenths', chordRhythm: 'sustained',
    chordProgressions: [[0,3,4,5], [0,5,3,4], [0,4,5,3], [5,3,0,4], [0,5,4,3], [3,4,0,5], [0,2,5,4], [5,4,3,0], [0,5,2,4]],
    bassStyle: 'root', bassOctave: 2,
  ...
  'hard_techno': {
    ...
    chordComplexity: 'triads', chordRhythm: 'stabs',
    chordProgressions: [[0,1,0,0], [0,0,1,0], [0,4,0,1], [0,1,4,1], [0,0,1,4], [1,0,1,0]],
    bassStyle: 'root', bassOctave: 1,
  ...
  'progressive_house': {
    ...
    chordProgressions: [[0,3,5,4], [0,5,3,4], [0,4,5,6], [0,5,4,3], [3,4,0,5], [0,2,5,4], [5,3,4,0]],
    bassStyle: 'root', bassOctave: 2,
    drumPattern: 'four_on_floor', hatDensity: 16, swingAmount: 0, energy: 0.6,
  },
  'afro_house': {
    ...
    chordProgressions: [[0,3,4,5], [0,2,3,4], [0,5,4,3], [0,3,5,4], [0,5,3,2], [3,5,0,4], [0,2,5,3], [0,5,2,4]],
    bassStyle: 'syncopated', bassOctave: 2,
  ...
  'organic_house': {
    ...
    chordComplexity: 'sevenths', chordRhythm: 'sustained',
    chordProgressions: [[0,3,5,4], [0,2,5,4], [0,5,3,2], [0,2,3,5], [3,2,0,5], [0,5,4,2]],
    bassStyle: 'root', bassOctave: 2,
  ...
  'trance': {
    ...
    chordProgressions: [[0,3,4,5], [0,5,3,4], [0,4,5,3], [5,4,3,0], [0,5,3,4], [3,0,4,5], [0,2,3,4]],
    bassStyle: 'root', bassOctave: 1,
  ...
  'uk_garage': {
    ...
    chordProgressions: [[0,3,4,5], [0,5,6,4], [0,2,3,5], [0,5,3,4], [3,5,0,4], [0,2,5,4]],
    bassStyle: 'syncopated', bassOctave: 2,
  ...
  'drum_and_bass': {
    ...
    chordComplexity: 'sevenths', chordRhythm: 'sustained',
    chordProgressions: [[0,3,4,5], [0,5,3,4], [5,3,0,4], [0,5,4,3], [3,5,4,0], [0,2,3,4]],
  ...
  'amapiano': {
    ...
    chordComplexity: 'sevenths', chordRhythm: 'offbeat',
    chordProgressions: [[0,3,4,5], [0,5,4,3], [0,2,3,4], [3,4,0,5], [0,5,3,4], [3,5,4,0], [0,3,5,4]],
  ...
  'lofi_hiphop': {
    ...
    chordProgressions: [[0,3,4,5], [0,5,3,4], [0,2,5,4], [0,5,4,3], [3,2,5,0], [0,2,3,5], [5,4,3,0]],
    bassStyle: 'root', bassOctave: 2,
  ...
  'hiphop': {
    ...
    melodyNoteLengths: [0.25, 0.5, 1, 2],
    chordComplexity: 'sevenths', chordRhythm: 'sustained',
    chordProgressions: [[0,3,4,0], [0,5,3,4], [0,4,5,3], [0,5,4,3], [3,5,0,4], [0,2,5,3]],
  ...
  'trap': {
    ...
    chordProgressions: [[0,3,4,0], [0,5,4,3], [0,0,3,4], [0,5,3,4], [3,0,4,5], [0,1,5,4], [5,3,0,4]],
    bassStyle: '808', bassOctave: 1,
  ...
  'pop': {
    ...
    melodyNoteLengths: [0.25, 0.5, 1, 2],
    chordComplexity: 'triads', chordRhythm: 'sustained',
    chordProgressions: [[0,4,5,3], [0,3,4,5], [0,5,3,4], [5,3,0,4], [0,5,4,3], [3,4,0,5]],
    bassStyle: 'root', bassOctave: 2,
  ...
  'rnb': {
    ...
    melodyNoteLengths: [0.5, 1, 1.5, 2],
    chordComplexity: 'extended', chordRhythm: 'sustained',
    chordProgressions: [[0,3,5,4], [0,2,3,5], [0,5,4,2], [3,5,0,4], [0,2,5,3], [5,3,4,0]],
    bassStyle: 'walking', bassOctave: 2,
  ...
  'disco_nu_disco': {
    ...
    melodyNoteLengths: [0.25, 0.5, 0.75, 1],
    chordComplexity: 'sevenths', chordRhythm: 'offbeat',
    chordProgressions: [[0,3,4,5], [0,5,4,3], [0,2,3,5], [3,4,0,5], [0,5,3,4], [5,4,3,0]],
