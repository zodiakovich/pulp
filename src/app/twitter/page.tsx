...
export const metadata = pageMeta({
  title: 'Twitter / X',
  description:
    'Official pulp announcements and tips on X (Twitter). This page will link to the live profile when it is active.',
  path: '/twitter',
});
