...
const SEED_GENERATIONS = [
  {
    id: 'seed-1',
    prompt: 'dark melodic techno, 128bpm, Am',
    genre: 'melodic_techno',
    bpm: 128,
    style_tag: 'Dark Hypnotic Dub',
    created_at: new Date().toISOString(),
  },
  {
    id: 'seed-2',
    prompt: 'afro house groove, 124bpm, Dm',
    genre: 'afro_house',
    bpm: 124,
    style_tag: 'Organic Afro Groove',
    created_at: new Date().toISOString(),
  },
  {
    id: 'seed-3',
    prompt: 'deep house late night, 120bpm, Fm',
    genre: 'deep_house',
    bpm: 120,
    style_tag: 'Jazzy UK Deep',
    created_at: new Date().toISOString(),
  },
  {
    id: 'seed-4',
    prompt: 'tech house peak time, 132bpm, Gm',
    genre: 'tech_house',
    bpm: 132,
    style_tag: 'Pumping Festival Tech',
    created_at: new Date().toISOString(),
  },
  {
    id: 'seed-5',
    prompt: 'melodic house sunrise, 122bpm, Em',
    genre: 'melodic_house',
    bpm: 122,
    style_tag: 'Euphoric Melodic',
    created_at: new Date().toISOString(),
  },
  {
    id: 'seed-6',
    prompt: 'hard techno industrial, 140bpm, Cm',
    genre: 'hard_techno',
    bpm: 140,
    style_tag: 'Peak-Time Industrial',
    created_at: new Date().toISOString(),
  },
];
